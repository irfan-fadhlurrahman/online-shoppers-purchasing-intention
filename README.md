...
* Revenue is the target variable that labels a visitor's purchase decision either purchase (class 1) or not purchase (class 0). The current condition is only 15% of total visitors who make a purchase. 
